...
import com.example.weatherko.databinding.FragmentSettingBinding
...
//        }
        ...
        binding.rbLanguage.setOnCheckedChangeListener { _, i ->
            val language = if (i == R.id.rb_arbic) "ar" else "en"
            MySharedPreference.setLanguage(language)
            viewModel.emitSettingsEvent(SettingsEvent.LanguageChanged(language))
        }
