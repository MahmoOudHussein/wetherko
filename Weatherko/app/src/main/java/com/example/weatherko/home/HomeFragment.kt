...
import com.example.weatherko.databinding.FragmentHomeBinding
import com.example.weatherko.home.HomeFragmentDirections.actionNavHomeToMapsFragment
import com.example.weatherko.home.mvvvm.HomeViewFactory
import com.example.weatherko.home.mvvvm.HomeViewModel
import com.example.weatherko.home.mvvvm.ResponseStateHome
import com.example.weatherko.home.mvvvm.repository.RepositoryHome
import com.example.weatherko.model.OneCall
import com.example.weatherko.model.OneCallHome
import com.example.weatherko.shareperf.MySharedPreference
...
class HomeFragment : Fragment() {
    ...
    private val My_LOCATION_PERMISSION_ID: Int = 44
...
companion object{
    ...
    private fun setData(data: OneCall) {
        ...
        binding.tvLastUpdateHome.text =
            getString(com.example.weatherko.R.string.lastUpdate) +" "+ getTime(data.current!!.dt)
        ...
        Glide.with(requireContext()).load(
            ...
            .error(
                AppCompatResources.getDrawable(
                    requireContext(),
                    com.example.weatherko.R.drawable.twotone_error_24
                )
            )
        ...
        binding.tvWindSpeedHome.text =
            data.current?.wind_speed.toString() + unit //check about the unit
