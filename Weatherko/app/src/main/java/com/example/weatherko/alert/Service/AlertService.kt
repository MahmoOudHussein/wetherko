...
import com.example.weatherko.MainActivity
...
class AlertService : Service() {
    ...
    private fun makeNotification(description: String): Notification {
        ...
        return NotificationCompat.Builder(
            ...
            .setSmallIcon(com.example.weatherko.R.drawable.twotone_notifications_24)
            .setContentText(description)
            .setContentTitle(applicationContext.getString(com.example.weatherko.R.string.header_notification))
    ...
    private fun notificationChannel() {
        val soundUri: Uri = Uri.parse(
            "android.resource://" +
                    ...
                    "/" +
                    com.example.weatherko.R.raw.alert
        )
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O) {
            val name: String = getString(com.example.weatherko.R.string.channel_name)
            val description = getString(com.example.weatherko.R.string.channel_description)
