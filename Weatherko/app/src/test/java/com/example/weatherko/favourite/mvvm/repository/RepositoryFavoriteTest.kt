...
import com.example.weatherko.favourite.mvvm.repository.repoitory.FakeLocalData
import com.example.weatherko.favourite.mvvm.repository.repoitory.FakeRemotelyData
...
class RepositoryFavoriteTest {
    ...
    private val list: List<FavouriteLocation> = listOf(
        ...
        FavouriteLocation(longitude = "erroribus", latitude = "montes", city = "Noordes"),
